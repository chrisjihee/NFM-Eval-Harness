...
uv pip install cmake ninja wheel packaging setuptools setuptools_scm
...
MAX_JOBS=$(nproc) uv pip install vllm --no-binary vllm --no-build-isolation --extra-index-url https://download.pytorch.org/whl/cu128 --index-strategy unsafe-best-match
...
uv pip install -e ./lm-evaluation-harness --extra-index-url https://download.pytorch.org/whl/cu128 --index-strategy unsafe-best-match
uv pip install "lm_eval[hf]" "lm_eval[api]" "lm_eval[vllm]" --extra-index-url https://download.pytorch.org/whl/cu128 --index-strategy unsafe-best-match
