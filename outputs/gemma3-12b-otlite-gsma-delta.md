...
|---|---|---:|---:|---:|---|
| `teleqna` | `open_telco_teleqna_mcgen` | 0.6879 | 0.7270 | +0.0391 | engine UNALIGNED (free gen vs constrained decode); dominant candidate-gap driver; measures gen-vs-constrained sensitivity |
| `teletables` | `open_telco_teletables_mcgen` | 0.2740 | 0.2700 | -0.0040 | engine UNALIGNED (free gen vs constrained decode); dominant candidate-gap driver; measures gen-vs-constrained sensitivity |
| `oranbench` | `open_telco_oranbench_mcgen` | 0.6953 | 0.7267 | +0.0314 | engine UNALIGNED (free gen vs constrained decode); dominant candidate-gap driver; measures gen-vs-constrained sensitivity |
| `srsranbench` | `open_telco_srsranbench_mcgen` | 0.8007 | 0.7800 | -0.0207 | engine UNALIGNED (free gen vs constrained decode); dominant candidate-gap driver; measures gen-vs-constrained sensitivity |
| `telemath` | `open_telco_telemath_gsma` | 0.2740 | 0.0400 | -0.2340 |  |
| `telelogs` | `open_telco_telelogs_gsma` | 0.1852 | 0.1500 | -0.0352 |  |
| `three_gpp` | `open_telco_3gpp_tsg_gsma` | 0.3298 | 0.3000 | -0.0298 |  |

## Leaderboard-convention unweighted mean (NOT computed by official GSMA code)

| Aggregate | Value |
|---|---:|
| local unweighted task mean | 0.4277 |
| public unweighted mean (computed from tasks) | 0.4638 |
| public average (reported) | 0.4638 |
| delta unweighted (local mean - public computed mean) | -0.0362 |
| local group acc (sample-weighted) | 0.4277 |
