...
#    caveats like "공식 재현 아님" are deliberately NOT matched). RELEASE_NOTES.md and
#    PACKAGING_CHECKLIST.md are excluded: they intentionally name these markers while
#    documenting the cleanup / what this very check looks for.
DELIV="README.md FINAL_DELIVERY_SUMMARY.md PROGRESS.md outputs/latest-summary.md INL_HANDOFF.md RESULTS_MANIFEST.md"
...
grep -nE "open_telco_otlite\b|open_telco_otfull\b" README.md PROGRESS.md outputs/latest-summary.md FINAL_DELIVERY_SUMMARY.md 2>/dev/null | sed 's/^/    /' || true
